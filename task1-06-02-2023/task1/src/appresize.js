...
const AppResize = (e) => {
	...
	if (appObj.mainWidth < appObj.mainHeight) {
		...
		appMc.mcLogo.y = 160 - (appObj.canvasHeight * 0.5) / appMc.mcUI.scale.y;
		appMc.mcLogo.x = 160 - (appObj.canvasWidth * 0.5) / appMc.mcUI.scale.y;
		...
		appMc.mcBg.scale.x = 0.1 + appObj.canvasWidth / 1280 / appMc.mcUI.scale.x;
