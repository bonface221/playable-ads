...
function showStage2(id) {
	...
	// TRYING the lightening Sequence

	gsap.from(appMc.mcSelectedSkinText.scale, 0.3,{delay:0.0, overwrite:"none", x:0, y:0, ease:Back.easeOut});
	gsap.from(appMc.mcBackArrow.scale, 0.3,{delay:0.3, overwrite:"none", x:0, y:0, ease:Back.easeOut});
