...
function onClickSkin(skinId) {
	...
	gsap.to(appMc.mcDefaultSkin.scale, 0.3,{delay:0.0, overwrite:"none", x:0, y:0, ease:Back.easeIn});
	// Buttons container and actual buttons		
	gsap.to(appMc.mcSelectBtnContainer.scale, 0.3,{delay:0.0, overwrite:"none", x:0, y:0, ease:Back.easeIn});
	gsap.to(appMc.mcChooseSkinText.scale, 0.3,{delay:0.0, overwrite:"none", x:0, y:0, ease:Back.easeIn});
