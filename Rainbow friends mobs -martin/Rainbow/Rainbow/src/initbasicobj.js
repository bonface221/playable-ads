const InitBasicObj = () => {
	...
	//Logo
	appMc.mcHeader = new createSprite({ p: appMc.mcUI });
	appSounds.mcCantrun = new createSprite({
		p: appMc.mcHeader,
		tex: "cantrun",
		scale: 0.4,
		visible: false,
	});
	appMc.mcHead = new createSprite({
		p: appMc.mcHeader,
		tex: "header",
		scale: 0.4,
		visible: true,
	});
	appMc.mcRectangle = new createSprite({
		p: appMc.mcUI,
		tex: "rectangle",
		scale: 0.2,
	});
	...
	//
	appMc.mcAvatarMain = new createSprite({ p: appMc.mcUI });
	appMc.mcAvatarA = new createSprite({
		p: appMc.mcAvatarMain,
		tex: "avatarA",
		scale: 0.3,
		visible: true,
	});
	appMc.mcAvatarB = new createSprite({
		p: appMc.mcAvatarMain,
		tex: "avatarB",
		scale: 0.3,
		visible: false,
	});
	appMc.mcAvatarE = new createSprite({
		p: appMc.mcAvatarMain,
		tex: "avatarE",
		scale: 0.3,
		visible: false,
	});
	appMc.mcAvatarF = new createSprite({
		p: appMc.mcAvatarMain,
		tex: "avatarF",
		scale: 0.3,
		visible: false,
	...
	appMc.mcChooseA = new createSprite({
		p: appMc.mcRectangle,
		tex: "chooseA",
		scale: 1.2,
		visible: true,
	...
	appMc.mcChooseB = new createSprite({
		p: appMc.mcRectangle,
		tex: "chooseB",
		scale: 1.2,
		visible: false,
	});
	appMc.mcChooseE = new createSprite({
		p: appMc.mcRectangle,
		tex: "chooseE",
		scale: 1.2,
		visible: false,
	});
	appMc.mcChooseF = new createSprite({
		p: appMc.mcRectangle,
		tex: "chooseF",
		scale: 1.2,
		visible: false,
	...
	appMc.mcLater = new createSprite({
		p: appMc.mcRectangle,
		tex: "later",
		scale: 1.2,
		visible: false,
	});
	appMc.mcHome = new createSprite({
		p: appMc.mcRectangle,
		tex: "hme",
		scale: 1.2,
		visible: false,
