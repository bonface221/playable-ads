const onDragStart = (e) => {
	appMc.mcGamePlayAvatar.dragging = true;
};

const onDragEnd = (e) => {
	appMc.mcGamePlayAvatar.dragging = false;
};

const onDragMove = (e) => {
	if (appMc.mcGamePlayAvatar.dragging === true) {
		appMc.mcGamePlayAvatar.x = e.data.getLocalPosition(appMc.mcWorldCamera).x;
	}
};
